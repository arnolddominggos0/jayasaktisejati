 ...
 * Active path: AppSheetService::syncRackContainerCheck(). See BaseSyncHandler for details.
 */
...
class RackContainerCheckHandler extends BaseSyncHandler
{
    protected bool $useFirstOrCreate = false;

    protected function modelClass(): string
    {
        return RackContainerCheck::class;
    }
