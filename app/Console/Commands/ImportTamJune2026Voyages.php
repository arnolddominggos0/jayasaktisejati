...
class ImportTamJune2026Voyages extends Command
{
    protected $signature = 'import:tam-june-2026-voyages';

    protected $description = 'Bootstrap TAM June 2026 voyages';

    public function handle(): int
    {
        $csv = storage_path('imports/tam/june2026/voyages.csv');
        ...
        $this->info(
            'TAM June 2026 voyage bootstrap selesai.'
        );
