...
class OperationalShipmentPage extends Page implements HasInfolists
{
    ...
    public function infolist(Infolist $infolist): Infolist
    {
        return $infolist->schema([
            ...
            Section::make('Informasi Shipment')
                ->collapsible()
                ->collapsed()
                ->schema([
                    ...
                    Section::make('Permintaan')
                        ->schema([
                            Grid::make(12)->schema([
                                ...
                                TextEntry::make('pickup_date')->label('Tanggal Pickup')->dateTime('d M Y H:i')->placeholder('—')->columnSpan(6),
                                TextEntry::make('estimated_ready_at')->label('Estimasi Selesai')->dateTime('d M Y H:i')->placeholder('—')->columnSpan(6),
                            ]),
                        ]),
