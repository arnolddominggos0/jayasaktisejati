...
use App\Filament\Resources\VesselCheckResource\RelationManagers;
...
class VesselCheckResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Vessel Check TAM';
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => Pages\CreateVesselCheck::route('/create'),
            'edit' => Pages\EditVesselCheck::route('/{record}/edit'),
        ];
    }
}
