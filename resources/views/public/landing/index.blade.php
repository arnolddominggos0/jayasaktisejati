...
<!-- Cara Kerja Pengiriman Section - 5 Stage Timeline -->
<section id="cara-kerja" class="py-20 bg-slate-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <span class="text-blue-600 font-semibold text-sm uppercase tracking-wide">Proses</span>
            <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mt-2 mb-4">Cara Kerja Pengiriman</h2>
            <p class="text-slate-600 max-w-2xl mx-auto">Dari permintaan hingga barang sampai tujuan, proses yang transparan dan terukur</p>
            <div class="w-20 h-1 bg-blue-600 mx-auto mt-4"></div>
        </div>
        ...
        <div class="hidden md:block">
            <div class="relative">
                <!-- Connector Line -->
                <div class="absolute top-10 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-200 via-blue-300 to-blue-200"></div>

                <div class="grid grid-cols-5 gap-4 relative">
                    <!-- Stage 1: Request Pengiriman -->
                    <div class="text-center group">
                        <div class="relative w-20 h-20 mx-auto mb-4">
                            <div class="absolute inset-0 bg-blue-100 rounded-2xl group-hover:bg-blue-200 transition-colors duration-300"></div>
                            ...
                            <div class="absolute -top-2 -right-2 w-7 h-7 bg-blue-600 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-md">1</div>
                        </div>
                        <h3 class="font-bold text-slate-800 text-sm mb-2">Request Pengiriman</h3>
                        <p class="text-slate-500 text-xs leading-relaxed px-2">Kirim permintaan pengiriman via WhatsApp atau telepon ke tim marketing kami.</p>
                    </div>

                    <!-- Stage 2: Pickup Barang -->
                    <div class="text-center group">
                        <div class="relative w-20 h-20 mx-auto mb-4">
                            <div class="absolute inset-0 bg-blue-100 rounded-2xl group-hover:bg-blue-200 transition-colors duration-300"></div>
                            <div class="relative w-full h-full flex items-center justify-center">
                            ...
                            <div class="absolute -top-2 -right-2 w-7 h-7 bg-blue-600 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-md">2</div>
                        </div>
                        <h3 class="font-bold text-slate-800 text-sm mb-2">Pickup Barang</h3>
                        <p class="text-slate-500 text-xs leading-relaxed px-2">Tim kami menjemput barang dari lokasi Anda sesuai jadwal yang disepakati.</p>
                    </div>

                    <!-- Stage 3: Proses Pengiriman -->
                    <div class="text-center group">
                        <div class="relative w-20 h-20 mx-auto mb-4">
                            <div class="absolute inset-0 bg-blue-100 rounded-2xl group-hover:bg-blue-200 transition-colors duration-300"></div>
                            <div class="relative w-full h-full flex items-center justify-center">
                            ...
                            <div class="absolute -top-2 -right-2 w-7 h-7 bg-blue-600 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-md">3</div>
                        </div>
                        <h3 class="font-bold text-slate-800 text-sm mb-2">Proses Pengiriman</h3>
                        <p class="text-slate-500 text-xs leading-relaxed px-2">Barang dikirim melalui jalur darat atau laut dengan handling yang profesional.</p>
                    </div>

                    <!-- Stage 4: Tracking Real-time -->
                    <div class="text-center group">
                        <div class="relative w-20 h-20 mx-auto mb-4">
                            <div class="absolute inset-0 bg-blue-100 rounded-2xl group-hover:bg-blue-200 transition-colors duration-300"></div>
                            <div class="relative w-full h-full flex items-center justify-center">
                            ...
                            <div class="absolute -top-2 -right-2 w-7 h-7 bg-blue-600 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-md">4</div>
                        </div>
                        <h3 class="font-bold text-slate-800 text-sm mb-2">Tracking Real-time</h3>
                        <p class="text-slate-500 text-xs leading-relaxed px-2">Pantau status dan lokasi pengiriman Anda kapan saja melalui sistem tracking online.</p>
                    </div>

                    <!-- Stage 5: Barang Diterima -->
                    <div class="text-center group">
                        <div class="relative w-20 h-20 mx-auto mb-4">
                            <div class="absolute inset-0 bg-green-100 rounded-2xl group-hover:bg-green-200 transition-colors duration-300"></div>
                            <div class="relative w-full h-full flex items-center justify-center">
                                <svg class="w-9 h-9 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                            </div>
                            <div class="absolute -top-2 -right-2 w-7 h-7 bg-green-600 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-md">5</div>
                        </div>
                        <h3 class="font-bold text-slate-800 text-sm mb-2">Barang Diterima</h3>
                        <p class="text-slate-500 text-xs leading-relaxed px-2">Barang sampai di lokasi tujuan dengan kondisi aman dan tanda terima dikonfirmasi.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="md:hidden space-y-6">
            ...
            <div class="flex items-start space-x-4">
                <div class="flex flex-col items-center flex-shrink-0">
                    <div class="relative w-14 h-14 bg-blue-100 rounded-2xl flex items-center justify-center">
                        <svg class="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                        </svg>
                        <div class="absolute -top-1 -right-1 w-5 h-5 bg-blue-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center">1</div>
                    </div>
                    <div class="w-0.5 h-full bg-blue-200 mt-2 min-h-[2rem]"></div>
                </div>
                <div class="pt-1 pb-4">
                    <h3 class="font-bold text-slate-800 text-sm mb-1">Request Pengiriman</h3>
                    <p class="text-slate-500 text-xs leading-relaxed">Kirim permintaan pengiriman via WhatsApp atau telepon ke tim marketing kami.</p>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
                <div class="flex flex-col items-center flex-shrink-0">
                    <div class="relative w-14 h-14 bg-blue-100 rounded-2xl flex items-center justify-center">
                        ...
                        <div class="absolute -top-1 -right-1 w-5 h-5 bg-blue-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center">2</div>
                    </div>
                    <div class="w-0.5 h-full bg-blue-200 mt-2 min-h-[2rem]"></div>
                </div>
                <div class="pt-1 pb-4">
                    <h3 class="font-bold text-slate-800 text-sm mb-1">Pickup Barang</h3>
                    <p class="text-slate-500 text-xs leading-relaxed">Tim kami menjemput barang dari lokasi Anda sesuai jadwal yang disepakati.</p>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
                <div class="flex flex-col items-center flex-shrink-0">
                    <div class="relative w-14 h-14 bg-blue-100 rounded-2xl flex items-center justify-center">
                        ...
                        <div class="absolute -top-1 -right-1 w-5 h-5 bg-blue-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center">3</div>
                    </div>
                    <div class="w-0.5 h-full bg-blue-200 mt-2 min-h-[2rem]"></div>
                </div>
                <div class="pt-1 pb-4">
                    <h3 class="font-bold text-slate-800 text-sm mb-1">Proses Pengiriman</h3>
                    <p class="text-slate-500 text-xs leading-relaxed">Barang dikirim melalui jalur darat atau laut dengan handling yang profesional.</p>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
                <div class="flex flex-col items-center flex-shrink-0">
                    <div class="relative w-14 h-14 bg-blue-100 rounded-2xl flex items-center justify-center">
                        ...
                        <div class="absolute -top-1 -right-1 w-5 h-5 bg-blue-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center">4</div>
                    </div>
                    <div class="w-0.5 h-full bg-blue-200 mt-2 min-h-[2rem]"></div>
                </div>
                <div class="pt-1 pb-4">
                    <h3 class="font-bold text-slate-800 text-sm mb-1">Tracking Real-time</h3>
                    <p class="text-slate-500 text-xs leading-relaxed">Pantau status dan lokasi pengiriman Anda kapan saja melalui sistem tracking online.</p>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
                <div class="flex flex-col items-center flex-shrink-0">
                    <div class="relative w-14 h-14 bg-green-100 rounded-2xl flex items-center justify-center">
                        <svg class="w-7 h-7 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <div class="absolute -top-1 -right-1 w-5 h-5 bg-green-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center">5</div>
                    </div>
                </div>
                <div class="pt-1">
                    <h3 class="font-bold text-slate-800 text-sm mb-1">Barang Diterima</h3>
                    <p class="text-slate-500 text-xs leading-relaxed">Barang sampai di lokasi tujuan dengan kondisi aman dan tanda terima dikonfirmasi.</p>
                </div>
            </div>
        </div>
    </div>
