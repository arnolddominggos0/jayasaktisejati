<x-filament-panels::page>
    ...
    <div class="grid grid-cols-2 gap-4 lg:grid-cols-5">
        ...
        <div class="rounded-xl bg-white p-5 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
            <div class="flex items-start justify-between">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500">Total Unit Masuk</p>
    ...
    @else
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800/60">
                            ...
                            @endif
                            <th class="px-4 py-3 text-center text-xs font-semibold uppercase tracking-wider text-sky-500 dark:text-sky-400">Unit Masuk</th>
        ...
        {{-- ================================================================
             DETAIL DRILL-DOWN (muncul setelah tabel saat baris dipilih)
        ================================================================ --}}
        @if ($detail)
                    ...
                    <div class="flex flex-wrap items-center gap-3 text-sm">
                        @if ($detail['unit_masuk'] !== null)
                            <span class="rounded-lg bg-sky-50 px-3 py-1 text-xs font-medium text-sky-700 shadow-sm ring-1 ring-sky-200 dark:bg-sky-900/20 dark:ring-sky-800 dark:text-sky-300">
                                Unit Masuk: <strong>{{ $detail['unit_masuk'] }}</strong>
                            </span>
                        @endif
    ...
    {{-- ====================================================================
         CONTAINER READINESS
         Demand planning harian — bukan container tracking.
         Kolom: Tanggal | Unit | Need | Available | Gap | Status | Aksi
    ==================================================================== --}}
    <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
    ...
    {{-- ====================================================================
         ...
         Rule: READY jika keduanya OK. NOT READY jika salah satu gagal.
    ==================================================================== --}}
