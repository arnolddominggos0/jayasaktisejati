<x-filament-panels::page>
 ...
 <div class="overflow-hidden rounded-xl border bg-white dark:bg-slate-900">
 <table class="w-full text-sm">
 <thead class="bg-gray-50 dark:bg-slate-950 text-xs uppercase tracking-wide text-gray-600 dark:text-slate-400">
 <tr>
