...
Jadwal Kapal — <span class="font-bold">Oktober 2025</span> <span
 ...
 <div class="p-3 rounded border bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-800 min-w-0 h-24">
 <div class="text-xs text-blue-700 dark:text-blue-300">Total Kapal</div>
 <div class="text-2xl font-bold text-blue-900 mt-1 leading-none truncate">3</div>
 <div class="text-xs text-blue-700 dark:text-blue-300">voyage</div>
 </div>
 ...
 <div class="p-3 rounded border bg-green-50 dark:bg-green-950/30 border-green-200 dark:border-green-800 min-w-0 h-24">
 <div class="text-xs text-green-700 dark:text-green-300">Rata-rata/Minggu</div>
 <div class="text-2xl font-bold text-green-900 mt-1 leading-none truncate">0.8</div>
 <div class="text-xs text-green-700 dark:text-green-300">kapal</div>
 </div>
