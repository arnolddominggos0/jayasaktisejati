<x-filament::widget>
    <x-filament::card>
        ...
        <div class="mb-2 text-sm text-gray-700">🗓️ Timeline Jadwal — Oktober 2025 (Mock)</div>
        ...
        <div class="mt-3 text-xs text-gray-600 flex flex-wrap items-center gap-4">
            ...
            <span class="text-gray-500">• Perjalanan (ETD → ETA). Mock tampilan, belum terhubung data.</span>
        </div>
    </x-filament::card>
</x-filament::widget>
